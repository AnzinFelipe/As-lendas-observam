...
int main() {
    ...
    inserir_local(&mapa, 50, "Associação Comercial de Pernambuco", comercial, NULL, &(Rectangle){200, 450, 200, 300}, &(Rectangle){1120, 450, 200, 300}, &(Rectangle){500, 700, 500, 100});
    inserir_local(&mapa, 51, "Avenida Barbosa Lima", barbosa_lima1, NULL, NULL, &(Rectangle){550, 400, 350, 250}, &(Rectangle){500, 700, 500, 100});
    inserir_local(&mapa, 75, "Avenida Barbosa Lima", barbosa_lima2, NULL, &(Rectangle){300, 350, 200, 300}, &(Rectangle){1120, 400, 200, 300}, &(Rectangle){500, 700, 500, 100});
    inserir_local(&mapa, 76, "Rua do Bom Jesus", bom_jesus1, NULL, NULL, &(Rectangle){570, 350, 350, 250}, &(Rectangle){500, 700, 500, 100});
    inserir_local(&mapa, 77, "Rua do Bom Jesus", bom_jesus2, NULL, NULL, &(Rectangle){570, 350, 350, 250}, &(Rectangle){500, 700, 500, 100});
    inserir_local(&mapa, 90, "Praça do Arsenal", arsenal, NULL, &(Rectangle){200, 360, 200, 400}, &(Rectangle){1120, 360, 200, 400}, &(Rectangle){500, 700, 500, 100});
    inserir_local(&mapa, 80, "Paço do Frevo", frevo, NULL, NULL, &(Rectangle){1120, 300, 200, 400}, &(Rectangle){500, 700, 500, 100});
    inserir_local(&mapa, 89, "Rua Barão Rodrigues Mendes", rodrigues_mendes, NULL, &(Rectangle){400, 350, 200, 300}, &(Rectangle){1070, 360, 250, 300}, &(Rectangle){500, 700, 500, 100});
    inserir_local(&mapa, 92, "Rua do Bom Jesus", bom_jesus3, NULL, NULL, &(Rectangle){650, 350, 350, 250}, &(Rectangle){500, 700, 500, 100});
    inserir_local(&mapa, 93, "Torre Malakoff", malakoff, NULL, NULL, NULL, &(Rectangle){500, 700, 500, 100});
